...
const recommendationCard = [
  {
    ...
    view: "I engineered a chatbot and text recognition system using Python, TensorFlow, and NLTK to enhance user engagement and automate processes. I transitioned a monolithic legacy system into a microservices architecture with Docker, Kubernetes, and Node.js, improving scalability and reliability. Additionally, I designed and implemented real-time dashboards and user interfaces with React, Redux, and TypeScript to provide seamless user experiences. My work also involved integrating blockchain technology, leveraging Web3.js and Ether.js to enable secure and decentralized smart contract interactions. Collaborating cross-functionally, I defined project roadmaps, optimized feature delivery, and ensured code quality through comprehensive testing with Jest and Cypress.",
