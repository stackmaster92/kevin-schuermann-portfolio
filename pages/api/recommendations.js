...
const recommendationCard = [
  ...
  },
  {
    ...
    view: "I developed responsive web applications with React, managed state using Redux-Saga, and styled interfaces with Tailwind CSS. On the backend, I built RESTful APIs using Python and Django, integrated Firebase for real-time data, and used Amazon RDS and GraphQL for scalable database operations. I also implemented WebSocket protocols for real-time updates and improved system architecture to ensure scalability and reliability.",
    linkednURL: "https://www.linkedin.com/in/muhammadullahafridi/",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    view: "I developed dynamic, responsive web applications using React.js to build interactive UIs, managing state with Redux and handling asynchronous actions using Redux-Saga. I designed pixel-perfect, responsive layouts with Tailwind CSS to ensure optimal user experience across devices, and implemented reusable, modular UI components for efficient code management and scalability. I followed best practices in frontend development to optimize performance and ensure smooth user interactions, while utilizing Git for version control to streamline collaboration and code management.",
